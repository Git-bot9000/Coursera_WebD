...
import { Nav, Navbar, NavbarBrand, NavbarToggler, Collapse, Modal, ModalHeader, ModalBody, NavItem, Jumbotron, 
	Form, FormGroup, Input, Button, Label, FormFeedback } from 'reactstrap';
